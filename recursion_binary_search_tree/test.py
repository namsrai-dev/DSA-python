...
check(2, bst.root.left.value, "Right child of root:")
check(4, bst.root.right.value, "Right child of root:")
check(1, bst.root.left.right.value, "Right child of root:")
check(5, bst.root.right.right.value, "Right child of root:")
